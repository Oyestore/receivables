...
var FinancingIntegrationService_1;
var _a;
Object.defineProperty(exports, "__esModule", { value: true });
exports.FinancingIntegrationService = void 0;
...
const eligibility_assessment_service_1 = require("./eligibility-assessment.service");
const working_capital_service_1 = require("./working-capital.service");
const supply_chain_finance_service_1 = require("./supply-chain-finance.service");
let FinancingIntegrationService = FinancingIntegrationService_1 = class FinancingIntegrationService {
    constructor(financingRequestRepository, invoiceRepository, paymentTransactionRepository, eligibilityService, workingCapitalService, supplyChainService, eventEmitter) {
        ...
        this.logger = new common_1.Logger(FinancingIntegrationService_1.name);
        ...
        try {
            ...
            if (autoFinancingEnabled) {
                ...
                const financingRequest = this.financingRequestRepository.create({
                    ...
                    financingType: financing_request_entity_1.FinancingType.INVOICE_FINANCING,
                    status: financing_request_entity_1.FinancingStatus.PENDING_ASSESSMENT,
                    metadata: {
                        autoCreated: true,
            ...
            switch (newStatus) {
                case 'paid':
                    ...
                    for (const request of financingRequests) {
                        if (request.status === financing_request_entity_1.FinancingStatus.FUNDED) {
                            // Mark financing as repaid
                            request.status = financing_request_entity_1.FinancingStatus.REPAID;
                ...
                case 'void':
                    ...
                    for (const request of financingRequests) {
                        if (request.status !== financing_request_entity_1.FinancingStatus.REPAID) {
                            // Mark financing as cancelled
                            request.status = financing_request_entity_1.FinancingStatus.CANCELLED;
                            request.updatedAt = new Date();
                            await this.financingRequestRepository.save(request);
     ...
     */
    async handlePaymentTransactionFailed(payload) {
        try {
     ...
     */
    async createFinancingRequestFromInvoice(invoiceId, organizationId, amount, financingType, tenorDays, nbfcPartnerId) {
     ...
     */
    async updateInvoiceWithFinancingInfo(invoiceId, financingRequestId, financingStatus) {
        ...
        invoice.metadata = {
            ...invoice.metadata,
            financing: {
                isFinanced: financingStatus === financing_request_entity_1.FinancingStatus.FUNDED,
                financingRequestId,
     ...
     */
    async createFinancingDisbursementTransaction(financingRequestId) {
        ...
        if (financingRequest.status !== financing_request_entity_1.FinancingStatus.APPROVED) {
            throw new Error('Financing request is not approved');
        }
        // Create disbursement transaction
        const transaction = this.paymentTransactionRepositor(Content, truncated, due, to, size, limit.Use, line, ranges, to, read in chunks);
    }
};
exports.FinancingIntegrationService = FinancingIntegrationService;
exports.FinancingIntegrationService = FinancingIntegrationService = FinancingIntegrationService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeorm_2.Repository,
        ...
        typeorm_2.Repository,
        eligibility_assessment_service_1.EligibilityAssessmentService,
        working_capital_service_1.WorkingCapitalService,
        supply_chain_finance_service_1.SupplyChainFinanceService, typeof (_a = typeof event_emitter_1.EventEmitter2 !== "undefined" && event_emitter_1.EventEmitter2) === "function" ? _a : Object])
], FinancingIntegrationService);
//# sourceMappingURL=financing-integration.service.js.map