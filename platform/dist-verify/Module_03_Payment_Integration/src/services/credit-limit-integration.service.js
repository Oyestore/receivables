...
var CreditLimitIntegrationService_1;
var _a, _b;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CreditLimitIntegrationService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const credit_limit_entity_1 = require("../entities/credit-limit.entity");
const credit_limit_approval_entity_1 = require("../entities/credit-limit-approval.entity");
...
const credit_limit_service_1 = require("./credit-limit.service");
const credit_limit_calculation_service_1 = require("./credit-limit-calculation.service");
/**
 ...
 */
let CreditLimitIntegrationService = CreditLimitIntegrationService_1 = class CreditLimitIntegrationService {
    constructor(creditLimitRepository, creditLimitApprovalRepository, creditAssessmentRepository, paymentHistoryRepository, paymentPredictionRepository, creditLimitService, creditLimitCalculationService) {
        this.creditLimitRepository = creditLimitRepository;
        this.creditLimitApprovalRepository = creditLimitApprovalRepository;
        this.creditAssessmentRepository = creditAssessmentRepository;
        this.paymentHistoryRepository = paymentHistoryRepository;
        this.paymentPredictionRepository = paymentPredictionRepository;
        this.creditLimitService = creditLimitService;
        this.creditLimitCalculationService = creditLimitCalculationService;
        this.logger = new common_1.Logger(CreditLimitIntegrationService_1.name);
    }
    /**
        ...
        if (activeLimit.creditAssessmentId) {
            ...
            if (previousAssessment) {
                ...
                if (scoreDifference >= 10) {
                    ...
                    const calculationResult = await this.creditLimitCalculationService.calculateRecommendedLimit(buyerId, tenantId, {
                    ...
                    return await this.creditLimitService.update(activeLimit.id, {
                        creditAssessmentId: assessment.id,
    ...
    async processNewPaymentHistory(paymentHistoryId, tenantId) {
        ...
        return await this.creditLimitService.updateUtilization(activeLimit.id, tenantId, totalUtilization);
    }
    /**
     ...
     * @returns Updated credit limit if applicable
     */
    async processNewPaymentPrediction(paymentPredictionId, tenantId) {
     ...
     */
    async checkCreditLimitForInvoice(buyerId, tenantId, amount) {
     ...
     */
    async updateCreditLimitAfterInvoice(buyerId, tenantId, invoiceId, amount) {
        ...
        // Update utilization
        const newUtilization = activeLimit.currentUtilization + amount;
        return await this.creditLimitService.updateUtilization(activeLimit.id, tenantId, newUtilization);
    }
    /**
     ...
     * @returns Updated credit limit
     */
    async updateCreditLimitAfterPayment(buyerId, tenantId, paymentId, amount) {
     ...
     */
    async getCreditLimitStatusForDashboard(buyerId, tenantId) {
        // Get active credit limit
        const activeLimit = await this.creditLimitService.findActiveLimitByBuyer(buyerId, tenantId);
        if (!activeLimit) {
            return {
...
exports.CreditLimitIntegrationService = CreditLimitIntegrationService;
exports.CreditLimitIntegrationService = CreditLimitIntegrationService = CreditLimitIntegrationService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(credit_limit_entity_1.CreditLimit)),
    __param(1, (0, typeorm_1.InjectRepository)(credit_limit_approval_entity_1.CreditLimitApproval)),
    __param(2, (0, typeorm_1.InjectRepository)(credit_assessment_entity_1.CreditAssessment)),
    __param(3, (0, typeorm_1.InjectRepository)(payment_history_entity_1.PaymentHistory)),
    __param(4, (0, typeorm_1.InjectRepository)(payment_prediction_entity_1.PaymentPrediction)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        typeorm_2.Repository,
        typeorm_2.Repository,
        typeorm_2.Repository,
        typeorm_2.Repository, typeof (_a = typeof credit_limit_service_1.CreditLimitService !== "undefined" && credit_limit_service_1.CreditLimitService) === "function" ? _a : Object, typeof (_b = typeof credit_limit_calculation_service_1.CreditLimitCalculationService !== "undefined" && credit_limit_calculation_service_1.CreditLimitCalculationService) === "function" ? _b : Object])
], CreditLimitIntegrationService);
//# sourceMappingURL=credit-limit-integration.service.js.map